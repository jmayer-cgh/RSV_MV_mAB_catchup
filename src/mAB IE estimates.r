...
# Save outputs
path_out <- "/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/PhD project/Project 2/Code base/RSV_MV_mAB_catchup/Fitting outputs/"
model_mab_runs_t %>% readr::write_rds(paste0(path_out, "mAB IE estimates.rds"))